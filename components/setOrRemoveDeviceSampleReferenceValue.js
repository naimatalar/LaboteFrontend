            ...
            <div className='col-12 tbls'>
                <div className='row justify-content-center mb-2'>
                    <div className='row col-12 mb-3' style={{ fontSize: 12 }}>
                        <b><i>Referans miktar değeri; tetkik edilecek numunenin hangi birim ile alınacağınını belirtir. Örnein gelen numuneye 100 gram üzerinden tetkik sağlanacak ise bu değer aşağıdan cihaza tanımlanmalıdır. </i></b>
                ...
                <div className='row col-12 mb-3 mt-3' style={{ fontSize: 18 }}>
                    <b>{device?.name + " "} </b> &nbsp; <span>Adlı Cihaz'ın Numune REferans Miktar Değerleri Listesi.</span>
                </div>
