        ...
        <>
            ...
            <Layout>
                ...
                <div className='content pr-3 pl-3'>
                    ...
                    <div className='card'>
                        <DataTable HideButtons Refresh={refreshDatatable} DataUrl={"Analysis/GetAnalisysRecordByLaboratoryId"} Headers={[
                            ["confirmUser", "Teslim Alan (Laboratuvar)"],
                        ...
                        ]} Title={<span><b>{getLaboratoryFromStorage().label}</b> Analiz Kayıtları</span>}
                            Description={<span><b>{getLaboratoryFromStorage().label}</b> Adlı laboratuvara ait analizine başlanmı ve sonlanmış bütün analizler.</span>}
                            HeaderButton={{
